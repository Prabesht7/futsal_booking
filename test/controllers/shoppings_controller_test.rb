...
class ShoppingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping" do
    assert_difference("Shopping.count") do
      post shoppings_url, params: { shopping: { category: @shopping.category, description: @shopping.description, name: @shopping.name, price: @shopping.price } }
    end
  ...
  test "should update shopping" do
    patch shopping_url(@shopping), params: { shopping: { category: @shopping.category, description: @shopping.description, name: @shopping.name, price: @shopping.price } }
