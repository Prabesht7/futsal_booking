...
ActiveRecord::Schema[7.0].define(version: 2024_05_19_083258) do
  ...
  create_table "line_items", force: :cascade do |t|
    ...
    t.index ["shopping_id"], name: "index_line_items_on_shopping_id"
  end
  ...
  create_table "order_items", force: :cascade do |t|
    ...
    t.index ["shopping_id"], name: "index_order_items_on_shopping_id"
  end
  ...
  add_foreign_key "line_items", "shoppings"
  add_foreign_key "order_items", "orders"
  add_foreign_key "order_items", "shoppings"
